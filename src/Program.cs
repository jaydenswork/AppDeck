    ...
    internal static class Program {
        ...
        static int SelfTest() {
            try {
                ...
                if(Preferences.NormalizeMainCloseAction(-1)!=0||Preferences.NormalizeMainCloseAction(0)!=0||Preferences.NormalizeMainCloseAction(1)!=1||Preferences.NormalizeMainCloseAction(2)!=2||Preferences.NormalizeMainCloseAction(3)!=0)throw new Exception("main close action validation");
